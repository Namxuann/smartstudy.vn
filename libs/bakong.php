...
function createPaymentBakong($params) {
    ...
    // Cấu hình API
    $my_payment_url = "https://raksmeypay.com/payment/request/".$SMARTSTUDY->site('bakong_profile_id');
    $profile_key = $SMARTSTUDY->site('bakong_profile_key');
...
function verifyPaymentBakong($transaction_id, $amount) {
    ...
    // Cấu hình API
    $payment_verify_url = "https://raksmeypay.com/api/payment/verify/".$SMARTSTUDY->site('bakong_profile_id');
    $profile_key = $SMARTSTUDY->site('bakong_profile_key');
    ...
    $proxyString = $SMARTSTUDY->site('bakong_proxy');
