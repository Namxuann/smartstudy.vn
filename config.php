...
$cron_suppliers = [
    // Hai khóa bên trái là mã giao thức cũ đã được lưu trong database.
    // Tên cron bên phải là tên độc lập do Smartstudy.vn quản lý.
    'SHOPCLONE6' => 'smartstudy_v6',
    'SHOPCLONE7' => 'smartstudy_v7',
    'SHOPKEY' => 'shopkey',
    'API_1' => 'api1',
    'API_6' => 'api6',
    'API_14' => 'api14',
    ...
    'API_52' => 'api52', // API_52 (Authorization Bearer header, me & products & orders endpoints)
    'API_53' => 'api53', // Customer API v2 (header x-api-key, sản phẩm nhiều variant, giao hàng qua endpoint delivery)
    'API_54' => 'api54', // Telegram Buyer API v2 (key dạng tgb_xxx qua query param, mua hàng cần Idempotency-Key)
];
