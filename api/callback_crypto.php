...
// if($token === false || $token != $SMARTSTUDY->site('crypto_token')){
//     die('Token xác minh không chính xác');
// }

// if($request_id === false || !$row = $SMARTSTUDY->get_row_safe(" SELECT * FROM `payment_crypto` WHERE `request_id` = ? ", [$request_id])){
