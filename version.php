...
<style>
    ...
    th:hover {
        ...
        /* Màu nền khi hover trên header */
    }

    td:hover {
        background-color: #eaeaea;
        /* Màu nền khi hover trên cell */
    }
</style>
</head>
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><b style="color:green;">NỘI BỘ SMARTSTUDY.VN</b></td>
            </tr>
            <tr>
                <td>SMTP</td>
                <td><b><?= $SMARTSTUDY->site('smtp_status') == 1 ? '<span style="color:green;">ON</span>' : '<span style="color:red;">OFF</span>'; ?></b></td>
            </tr>
            <tr>
                <td>Debug Auto Bank</td>
                <td><b><?= $SMARTSTUDY->site('debug_auto_bank') == 1 ? '<span style="color:green;">ON</span>' : '<span style="color:red;">OFF</span>'; ?></b></td>
            </tr>
            <tr>
                <td>Debug API Suppliers</td>
                <td><b><?= $SMARTSTUDY->site('debug_api_suppliers') == 1 ? '<span style="color:green;">ON</span>' : '<span style="color:red;">OFF</span>'; ?></b></td>
            </tr>
            <tr>
                <td>Phiên bản PHP</td>
            ...
            <tr>
                ...
                <td><b><?= format_currency($SMARTSTUDY->site('bank_min')); ?></b></td>
            </tr>
            <tr>
                <td>Số tiền nạp Bank tối đa</td>
                <td><b><?= format_currency($SMARTSTUDY->site('bank_max')); ?></b></td>
            </tr>
            <tr>
                <td>Prefix</td>
                <td><b><?= $SMARTSTUDY->site('prefix_autobank'); ?>{id}</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_bank')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/momo.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_momo')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/thesieure.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_thesieure')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/task.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_task')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/sending_email.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_sending_email')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/cron.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('check_time_cron_cron')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/checklive/clone.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('time_cron_checklive_clone')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/checklive/hotmail.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('time_cron_checklive_hotmail')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/checklive/gmail.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('time_cron_checklive_gmail')); ?></b></td>
            </tr>
            <tr>
                <td><?= base_url('cron/checklive/instagram.php'); ?></td>
                <td><b><?= timeAgo($SMARTSTUDY->site('time_cron_checklive_instagram')); ?></b></td>
            </tr>
            ...
            foreach ($cron_suppliers as $key => $value) {
                ...
                echo '<td><b>' . timeAgo($SMARTSTUDY->site($time_var)) . '</b></td>';
                echo '</tr>';
            }
            ?>
        </tbody>
