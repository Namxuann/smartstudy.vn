...
$body = [
    'title' => __('Thay đổi mật khẩu').' | '.$SMARTSTUDY->site('title'),
...
if($token === false || !$getUser = $SMARTSTUDY->get_row_safe("SELECT * FROM `users` WHERE `token_forgot_password` = ? AND `token_forgot_password` IS NOT NULL", [$token])) {
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                    <div class="user-form-logo"><a href="<?=base_url();?>"><img
                                src="<?=BASE_URL($SMARTSTUDY->site('logo_light'));?>" alt="logo"></a></div>
                    ...
                    <div class="user-form-footer">
                        <p>&COPY; Copyright by <a href="<?=BASE_URL();?>"><?=$SMARTSTUDY->site('title');?></a></p>
                    </div>
                </div>
            </div>
        </div>
