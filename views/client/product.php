...
if (isset($_GET['slug'])) {
    ...
    if (!$product = $SMARTSTUDY->get_row_safe("SELECT * FROM `products` WHERE `slug` = ? AND `status` = 1", [$slug])) {
        redirect(base_url());
    }
} else {
    redirect(base_url());
...
<section class="inner-section" style="margin-bottom:40px;">
    <div class="container">
        <div class="row">
            <?php if($SMARTSTUDY->site('product_photo_display') == 1 && $product['images'] != ''):?>
            ...
            <div class="col-lg-8" id="col2">
                <div class="details-content">
                    ...
                    <div class="details-meta">
                        <?php $isCourse = (($product['product_type'] ?? 'stock') === 'course'); ?>
                        <?php $stock = $isCourse ? 1 : ($product['supplier_id'] != 0 ? $product['api_stock'] : getStock($product['code']));?>
