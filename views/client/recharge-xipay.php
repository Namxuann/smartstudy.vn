...
$body = [
    'title' => __('Recharge XiPay').' | '.$SMARTSTUDY->site('title'),
...
if(isset($_POST['WIDtotal_fee'])){
    ...
    $price = $amount * $SMARTSTUDY->site('gateway_xipay_rate');
    ...
    $SMARTSTUDY->insert('payment_xipay', [
        'user_id'       => $getUser['id'],
        'out_trade_no'  => $out_trade_no,
        'type'          => $type,
        'price'         => $price,
