...
$body = [
    'title' => __('Nạp tiền bằng thẻ cào').' | '.$SMARTSTUDY->site('title'),
...
$sum = $SMARTSTUDY->get_row_safe($sum_sql, array_merge($where_params, ['completed']))['total'] ?? 0;
...
$sum_waiting = $SMARTSTUDY->get_row_safe($sum_waiting_sql, array_merge($where_params, ['waiting']))['total'] ?? 0;
...
function totalPrice() {
    ...
    total = amount - amount * <?=$SMARTSTUDY->site('card_ck');?> / 100;
