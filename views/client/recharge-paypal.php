...
$body = [
    'title' => __('Nạp tiền bằng PayPal').' | '.$SMARTSTUDY->site('title'),
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?=__('Đã thanh toán:');?>
                                            <strong
                                                style="color:red;"><?=format_currency($SMARTSTUDY->get_row_safe(" SELECT SUM(`price`) FROM `payment_paypal` WHERE $where_clause ", $where_params)['SUM(`price`)']);?></strong>
...
<script src="https://www.paypal.com/sdk/js?client-id=<?=$SMARTSTUDY->site('paypal_clientId');?>&currency=USD"></script>
