...
$body = [
    'title' => __('Nạp tiền bằng Toyyibpay').' | '.$SMARTSTUDY->site('title'),
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="account-card">
                    ...
                    <?=$SMARTSTUDY->site('toyyibpay_notice');?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="account-card">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?=__('Paid:');?> RM
                                            <strong
                                                style="color:red;"><?=format_cash($SMARTSTUDY->get_row_safe("SELECT SUM(`amount`) FROM `payment_toyyibpay` WHERE $where_clause AND `status` = ?", array_merge($where_params, [1]))['SUM(`amount`)']);?></strong>
                                            | <?=__('Unpaid:');?>
                                            RM <strong
                                                style="color:blue;"><?=format_cash($SMARTSTUDY->get_row_safe("SELECT SUM(`amount`) FROM `payment_toyyibpay` WHERE $where_clause AND `status` = ?", array_merge($where_params, [0]))['SUM(`amount`)']);?></strong>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
