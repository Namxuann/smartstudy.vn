...
$body = [
    'title' => __('Recharge TriPay') . ' | ' . $SMARTSTUDY->site('title'),
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="account-card">
                    <h4 class="account-title"><?= $SMARTSTUDY->site('tripay_name'); ?></h4>
                    <div class="text-center mb-4">
                        <div class="d-flex justify-content-center">
                            <img width="150px" src="<?= base_url($SMARTSTUDY->site('tripay_icon') ?: 'mod/img/logo-tripay.webp'); ?>" alt="<?= $SMARTSTUDY->site('tripay_name') ?: 'TriPay'; ?>" />
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <small class="text-muted">Min: <?= number_format($SMARTSTUDY->site('tripay_min')); ?> IDR - Max: <?= number_format($SMARTSTUDY->site('tripay_max')); ?> IDR</small>
                        </div>
                    </div>
                    <div class="row mb-3">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?= __('Paid:'); ?>
                                            <strong style="color:red;"><?= format_currency($SMARTSTUDY->get_row_safe("SELECT SUM(`price`) FROM `payment_tripay` WHERE $where_clause AND `status` = 1", $where_params)['SUM(`price`)']); ?></strong>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
...
<script type="text/javascript">
    // Rate configuration
    var rate = <?= $SMARTSTUDY->site('tripay_rate') ?: 1; ?>;
