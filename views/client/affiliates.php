...
$body = [
    'title' => __('Affiliate Program').' | '.$SMARTSTUDY->site('title'),
        ...
        <div class="row">
                ...
                <div class="account-card">
                    ...
                    <div class="wallet-card-group">
                        ...
                        <div class="wallet-card">
                            ...
                            <h3><?=format_cash($SMARTSTUDY->get_row_safe("SELECT COUNT(id) as total FROM `users` WHERE `ref_id` = ?", [$getUser['id']])['total']);?>
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="account-card">
                    ...
                    <br>
                    <?=$SMARTSTUDY->site('affiliate_note');?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="account-card">
