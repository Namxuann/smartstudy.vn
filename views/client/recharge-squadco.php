...
$body = [
    'title' => __('Recharge Squadco').' | '.$SMARTSTUDY->site('title'),
...
if($SMARTSTUDY->site('squadco_status') != 1){
    redirect(base_url());
}
        ...
        <div class="row">
                ...
                <div class="account-card">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label"
                            for="example-hf-email"><?=__('Enter the deposit amount: ('.$SMARTSTUDY->site('squadco_currency_code').')');?></label>
                        <div class="col-sm-8">
            ...
            <div class="col-md-5">
                <div class="account-card">
                    ...
                    <?=$SMARTSTUDY->site('squadco_notice');?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="account-card">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?=__('Paid:');?>
                                            <strong
                                                style="color:red;"><?=format_currency($SMARTSTUDY->get_row_safe(" SELECT SUM(`price`) FROM `payment_squadco` WHERE $where_clause ", $where_params)['SUM(`price`)']);?></strong>
