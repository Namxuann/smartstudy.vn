...
<body>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-5">
                    <div class="header-top-welcome">
                        <p><?= $SMARTSTUDY->site('notice_top_left'); ?></p>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="header-top-select">
                        <div class="header-select"><i class="icofont-world"></i>
                            <?php if ($SMARTSTUDY->site('language_type') == 'manual'): ?>
                            ...
                            <?php elseif ($SMARTSTUDY->site('language_type') == 'gtranslate'): ?>
                                <?= $SMARTSTUDY->site('gtranslate_script'); ?>
                            <?php endif ?>
                        </div>
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-media-group">
                    ...
                    <a href="<?= base_url(); ?>">
                        <img src="<?= BASE_URL($SMARTSTUDY->site('logo_light')); ?>" alt="logo"></a>
                    <button class="header-src"><i class="fas fa-search"></i></button>
                </div>
                <a href="<?= base_url(); ?>" class="header-logo"><img src="<?= BASE_URL($SMARTSTUDY->site('logo_light')); ?>"
                        alt="logo"></a>
                ...
                <div class="header-widget-group">
                    ...
                    <a href="<?= base_url('client/favorites'); ?>" class="header-widget"
                        ...
                        <sup
                            id="numFavorites"><?= isset($getUser) ? $SMARTSTUDY->get_row_safe(" SELECT COUNT(id) FROM `favorites` WHERE `user_id` = ? ", [$getUser['id']])["COUNT(id)"] : 0; ?></sup>
                    </a>
                    ...
                    <?php if (isset($getUser)): ?>
                        <a href="<?= base_url('client/profile'); ?>" class="header-widget" title="Profile">
                            <img src="<?= BASE_URL($SMARTSTUDY->site('avatar')); ?>" alt="user"><span>
                    ...
                    <?php else: ?>
                        <a href="<?= base_url('client/login'); ?>" class="header-widget" title="Login">
                            <img src="<?= BASE_URL($SMARTSTUDY->site('avatar')); ?>" alt="user"><span>Login</span>
                        </a>
                    <?php endif ?>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="navbar-content">
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item dropdown">
                                ...
                                <ul class="dropdown-position-list">
                                    ...
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('toyyibpay_status') == 1): ?>
                                    ...
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('squadco_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-squadco'); ?>"><img width="20px"
                                                    src="<?= base_url('assets/img/icon-squadco.png'); ?>">
                                                <?= __('Squadco Nigeria'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('flutterwave_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-flutterwave'); ?>"><img width="20px"
                                                    src="<?= base_url('mod/img/icon-flutterwave.png'); ?>">
                                                <?= __('Flutterwave'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('gateway_xipay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-xipay'); ?>"><img width="20px"
                                                    src="<?= base_url('mod/img/logo-xipay.webp'); ?>">
                                                <?= __('AliPay & WeChat Pay'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('lempay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-lempay'); ?>"><img width="20px"
                                                    src="<?= base_url($SMARTSTUDY->site('lempay_icon') ?: 'mod/img/logo-lempay.webp'); ?>">
                                                <?= __($SMARTSTUDY->site('lempay_name') ?: 'LemPay'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('tripay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-tripay'); ?>"><img width="20px"
                                                    src="<?= base_url($SMARTSTUDY->site('tripay_icon') ?: 'mod/img/logo-tripay.webp'); ?>">
                                                <?= __($SMARTSTUDY->site('tripay_name') ?: 'TriPay Indonesia'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('zinipay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-zinipay'); ?>"><img width="20px"
                                                    src="<?= base_url($SMARTSTUDY->site('zinipay_icon') ?: 'mod/img/logo-zinipay.webp'); ?>">
                                                <?= __($SMARTSTUDY->site('zinipay_name') ?: 'ZiniPay'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('korapay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-korapay'); ?>"><img width="20px"
                                                    src="<?= base_url('mod/img/logo-korapay.webp'); ?>">
                                                <?= __('Korapay Africa'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('pocketfi_status') == 1): ?>
                                    ...
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('paymentpoint_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-paymentpoint'); ?>"><img width="20px"
                                                    src="<?= base_url($SMARTSTUDY->site('paymentpoint_icon') ?: 'mod/img/paymentpoint.png'); ?>">
                                                <?= __($SMARTSTUDY->site('paymentpoint_name') ?: 'PaymentPoint'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('dsociopay_status') == 1): ?>
                                        <li><a href="<?= base_url('?action=recharge-dsociopay'); ?>"><img width="20px"
                                                    src="<?= base_url($SMARTSTUDY->site('dsociopay_icon') ?: 'mod/img/dsociopay.png'); ?>">
                                                <?= __($SMARTSTUDY->site('dsociopay_name') ?: 'DSocioPay'); ?></a></li>
                                    <?php endif ?>
                                    <?php if ($SMARTSTUDY->site('tmweasyapi_status') == 1): ?>
                            ...
                            <?php endif ?>
                            <?php if ($SMARTSTUDY->site('blog_status') == 1): ?>
                                <li class="navbar-item"><a class="navbar-link"
                            ...
                            <?php endif ?>
                            <?php if (isset($getUser) && $getUser['ctv'] != 0 && $SMARTSTUDY->site('ctv_status') == 1): ?>
                                <li class="navbar-item"><a class="navbar-link"
                        ...
                        <div class="navbar-info-group">
                            <div class="navbar-info"><?= $SMARTSTUDY->site('icon_hotline'); ?>
                                <p><small><?= __('Hotline'); ?></small><span><?= $SMARTSTUDY->site('hotline'); ?></span></p>
                            </div>
                            <div class="navbar-info"><?= $SMARTSTUDY->site('icon_email'); ?>
                                <p><small><?= __('Email'); ?></small><span><?= $SMARTSTUDY->site('email'); ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <ul class="category-list">
            ...
            <?php if ($SMARTSTUDY->site('lempay_status') == 1): ?>
                <li class="category-item"><a class="category-link" href="<?= base_url('?action=recharge-lempay'); ?>"><img
                            style="margin-right: 10px;" width="30px" src="<?= base_url($SMARTSTUDY->site('lempay_icon') ?: 'mod/img/logo-lempay.webp'); ?>">
                        <?= __($SMARTSTUDY->site('lempay_name') ?: 'LemPay'); ?></a></li>
            <?php endif ?>
            <?php if ($SMARTSTUDY->site('tripay_status') == 1): ?>
                <li class="category-item"><a class="category-link" href="<?= base_url('?action=recharge-tripay'); ?>"><img
                            style="margin-right: 10px;" width="30px" src="<?= base_url($SMARTSTUDY->site('tripay_icon') ?: 'mod/img/logo-tripay.webp'); ?>">
                        <?= __($SMARTSTUDY->site('tripay_name') ?: 'TriPay Indonesia'); ?></a></li>
            <?php endif ?>
            <?php if ($SMARTSTUDY->site('zinipay_status') == 1): ?>
                <li class="category-item"><a class="category-link" href="<?= base_url('?action=recharge-zinipay'); ?>"><img
                            style="margin-right: 10px;" width="30px" src="<?= base_url($SMARTSTUDY->site('zinipay_icon') ?: 'mod/img/logo-zinipay.webp'); ?>">
                        <?= __($SMARTSTUDY->site('zinipay_name') ?: 'ZiniPay'); ?></a></li>
            <?php endif ?>
            ...
            <?php if ($SMARTSTUDY->site('paymentpoint_status') == 1): ?>
                <li class="category-item"><a class="category-link" href="<?= base_url('?action=recharge-paymentpoint'); ?>"><img
                            style="margin-right: 10px;" width="30px" src="<?= base_url($SMARTSTUDY->site('paymentpoint_icon') ?: 'mod/img/paymentpoint.png'); ?>">
                        <?= __($SMARTSTUDY->site('paymentpoint_name') ?: 'PaymentPoint'); ?></a></li>
            <?php endif ?>
            <?php if ($SMARTSTUDY->site('dsociopay_status') == 1): ?>
                <li class="category-item"><a class="category-link" href="<?= base_url('?action=recharge-dsociopay'); ?>"><img
                            style="margin-right: 10px;" width="30px" src="<?= base_url($SMARTSTUDY->site('dsociopay_icon') ?: 'mod/img/dsociopay.png'); ?>">
                        <?= __($SMARTSTUDY->site('dsociopay_name') ?: 'DSocioPay'); ?></a></li>
            <?php endif ?>
            <?php if ($SMARTSTUDY->site('tmweasyapi_status') == 1): ?>
    ...
    <aside class="nav-sidebar">
        <div class="nav-header"><a href="<?= base_url(); ?>"><img src="<?= BASE_URL($SMARTSTUDY->site('logo_light')); ?>"
        ...
        <div class="nav-content">
            ...
            <div class="nav-info-group">
                <div class="nav-info"><?= $SMARTSTUDY->site('icon_hotline'); ?>
                    <p><span><?= $SMARTSTUDY->site('hotline'); ?></span></p>
                </div>
                <div class="nav-info"><?= $SMARTSTUDY->site('icon_email'); ?>
                    <p><span><?= $SMARTSTUDY->site('email'); ?></span></p>
                </div>
            </div>
        </div>
    </aside>
