...
$body = [
    'title' => __('Recharge OpenPix').' | '.$SMARTSTUDY->site('title'),
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="account-card">
                    ...
                    <?=$SMARTSTUDY->site('openpix_notice');?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="account-card">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?=__('Paid:');?>
                                            <strong
                                                style="color:red;"><?=format_currency($SMARTSTUDY->get_row_safe(" SELECT SUM(`price`) FROM `payment_openpix` WHERE $where_clause AND `status` = 1 ", $where_params)['SUM(`price`)']);?></strong>
