...
$body = [
    'title' => __('Recharge LemPay') . ' | ' . $SMARTSTUDY->site('title'),
...
$listDatatable = $SMARTSTUDY->get_list_safe($sql, $params_with_limit);

$count_sql = "SELECT * FROM `payment_lempay` WHERE $where_clause ORDER BY id DESC";
$totalDatatable = $SMARTSTUDY->num_rows_safe($count_sql, $where_params);
        ...
        <div class="row">
                ...
                <div class="account-card">
                    ...
                    <div class="text-center mb-4">
                        <div class="d-flex justify-content-center">
                            <img width="120px" src="<?= base_url($SMARTSTUDY->site('lempay_icon') ?: ''); ?>" alt="<?= $SMARTSTUDY->site('lempay_name') ?: 'LemPay'; ?>" />
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <small class="text-muted">Min: <?= $SMARTSTUDY->site('lempay_min'); ?> CNY - Max: <?= $SMARTSTUDY->site('lempay_max'); ?> CNY</small>
                        </div>
                    </div>
                    <div class="row mb-3">
            ...
            <div class="col-md-5">
                <div class="account-card">
                    ...
                    <?= $SMARTSTUDY->site('lempay_notice'); ?>
                    <?php if (empty($SMARTSTUDY->site('lempay_notice'))): ?>
                        <ul>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="float-right">
                                            <?= __('Paid:'); ?>
                                            <strong style="color:red;"><?= format_currency($SMARTSTUDY->get_row_safe("SELECT SUM(`price`) FROM `payment_lempay` WHERE $where_clause AND `status` = 1", $where_params)['SUM(`price`)']); ?></strong>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
...
<script type="text/javascript">
    // Rate configuration
    var rates = {
        'alipay': <?= $SMARTSTUDY->site('lempay_rate_alipay') ?: $SMARTSTUDY->site('lempay_rate'); ?>,
        'wxpay': <?= $SMARTSTUDY->site('lempay_rate_wxpay') ?: $SMARTSTUDY->site('lempay_rate'); ?>,
        'usdt': <?= $SMARTSTUDY->site('lempay_rate_usdt') ?: $SMARTSTUDY->site('lempay_rate'); ?>
    };
    ...
    function calculateReceive() {
        ...
        var rate = rates[paymentType] || <?= $SMARTSTUDY->site('lempay_rate'); ?>;
