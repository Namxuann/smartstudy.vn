...
$body = [
    'title' => __('Blogs').' | '.$SMARTSTUDY->site('title'),
                ...
                <div class="col-lg-4">
                    ...
                    <div class="blog-widget">
                        ...
                        <ul class="blog-widget-feed">
                            <?php foreach($SMARTSTUDY->get_list_safe("SELECT * FROM `posts` WHERE `status` = ? ORDER BY `view` DESC", [1]) as $popular):?>
                            <li>
                    ...
                    <div class="blog-widget">
                        ...
                        <ul class="blog-widget-category">
                            <?php foreach($SMARTSTUDY->get_list_safe("SELECT * FROM `post_category` WHERE `status` = ?", [1]) as $category):?>
                            <li><a href="<?=base_url('?action=blogs&category='.$category['id']);?>"><?=$category['name'];?>
                                    <span><?=$SMARTSTUDY->get_row_safe("SELECT COUNT(id) as total FROM `posts` WHERE `category_id` = ?", [$category['id']])['total'];?></span></a>
                            </li>
                            <?php endforeach?>
                        </ul>
                    </div>
