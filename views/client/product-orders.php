...
$body = [
    'title' => __('Lịch sử đơn hàng').' | '.$SMARTSTUDY->site('title'),
...
if(!empty($_GET['account'])){
    ...
    if($account !== false) {
        $product_sold_rows = $SMARTSTUDY->get_list_safe('SELECT `trans_id` FROM `product_sold` WHERE `account` LIKE ? AND `buyer` = ?', ['%' . $account . '%', $getUser['id']]);
...
<section class="inner-section">
    <div class="container">
        <?php if($SMARTSTUDY->site('notice_orders') != ''):?>
        <div class="col-md-12">
            <div class="account-card pt-3">
                <?=$SMARTSTUDY->site('notice_orders');?>
            </div>
        </div>
        <?php endif?>
        <div class="row">
                                    ...
                                    <td colspan="8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-right">
                                                ...
                                                $stats = $SMARTSTUDY->get_row_safe("SELECT 
