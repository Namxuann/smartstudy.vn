...
$body = [
    'title' => __('Dashboard') . ' | ' . $SMARTSTUDY->site('title'),
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-secondary shadow-sm" role="status">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h5 class="mb-1"><i class="fas fa-shield-alt text-primary me-2"></i>Smartstudy.vn</h5>
                        <div class="text-muted">Nền tảng do Smartstudy.vn quản lý nội bộ</div>
                    </div>
                    <span class="badge bg-primary">Phiên bản <?= htmlspecialchars($config["version"]); ?></span>
                </div>
                <div class="mt-3 small">
                    Mã nguồn và phiên bản được kiểm soát trực tiếp trong hệ thống Smartstudy.vn.
                </div>
        </div>
        ...
        <?php endif ?>
        <?php if ($SMARTSTUDY->site('smtp_status') == 1 && time() - $SMARTSTUDY->site('check_time_cron_email_queue') >= 120): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
        ...
        <?php endif ?>
        <?php if ($SMARTSTUDY->site('telegram_status') == 1 && time() - $SMARTSTUDY->site('check_time_cron_telegram_queue') >= 120): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
                ...
                <?= __('Vui lòng thực hiện'); ?> <b><a target="_blank" class="text-primary"
                        href="https://smartstudy.vn">CRON JOB</a></b>
                <?= __('liên kết'); ?>:
                <a class="text-primary" href="<?= base_url('cron/process_telegram_queue.php?key=' . $SMARTSTUDY->site('key_cron_job')); ?>"
                    target="_blank">
                    <?= base_url('cron/process_telegram_queue.php?key=' . $SMARTSTUDY->site('key_cron_job')); ?>
                </a> <?= __('1 phút 1 lần để hệ thống tự động gửi thông báo Telegram.'); ?>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i
                        class="bi bi-x"></i></button>
            </div>
        <?php endif ?>
        <?php if ($SMARTSTUDY->site('debug_auto_bank') == 1): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
