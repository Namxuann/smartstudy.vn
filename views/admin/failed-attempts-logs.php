...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `failed_attempts` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `failed_attempts` WHERE $where ORDER BY id DESC ");
