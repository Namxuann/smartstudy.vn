...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `payment_lempay` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `payment_lempay` WHERE $where ORDER BY id DESC ");
...
$total_yesterday = intval($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 AND  `created_at` LIKE '%" . $yesterday . "%' ")['SUM(price)']);
$total_today = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 AND `created_at` LIKE '%" . $currentDate . "%' ")['SUM(price)'];
$total_all_time = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 ")['SUM(price)'];
                            ...
                            <div class="row">
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control" name="lempay_status">
                                                    <option <?= $SMARTSTUDY->site('lempay_status') == 1 ? 'selected' : ''; ?> value="1">ON</option>
                                                    <option <?= $SMARTSTUDY->site('lempay_status') == 0 ? 'selected' : ''; ?> value="0">OFF</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_name') ?: 'LemPay (AliPay, WeChat, USDT)'; ?>" name="lempay_name" placeholder="LemPay (AliPay, WeChat, USDT)">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center mb-2">
                                                    <?php if ($SMARTSTUDY->site('lempay_icon')): ?>
                                                        <img src="<?= base_url($SMARTSTUDY->site('lempay_icon')); ?>" width="40" height="40" class="me-2 rounded" style="object-fit: contain;">
                                                    <?php endif; ?>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_pid'); ?>" name="lempay_pid" placeholder="1001">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label">Merchant Key</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_key'); ?>" name="lempay_key" placeholder="xxxxxxxxxxxxxx">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label">API URL</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_api_url') ?: 'https://a119a.lempay.com'; ?>" name="lempay_api_url">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_min'); ?>" name="lempay_min">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label">Max (CNY)</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_max'); ?>" name="lempay_max">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_rate'); ?>" name="lempay_rate">
                                    ...
                                    <div class="col-lg-12 col-xl-4">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_rate_alipay') ?: $SMARTSTUDY->site('lempay_rate'); ?>" name="lempay_rate_alipay" placeholder="Để trống = dùng rate mặc định">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-4">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_rate_wxpay') ?: $SMARTSTUDY->site('lempay_rate'); ?>" name="lempay_rate_wxpay" placeholder="Để trống = dùng rate mặc định">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-4">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('lempay_rate_usdt') ?: $SMARTSTUDY->site('lempay_rate'); ?>" name="lempay_rate_usdt" placeholder="Để trống = dùng rate mặc định">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="lempay_notice" name="lempay_notice"><?= $SMARTSTUDY->site('lempay_notice'); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']); ?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']); ?>
                                        </p>
                                ...
                                const data = {
                                    ...
                                    datasets: [{
                                        ...
                                        data: [
                                            ...
                                            for ($day = 1; $day <= $numOfDays; $day++) {
                                                $date = "$year-$month-$day";
                                                $row = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_lempay WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="float-right">
                                                <?= __('Paid:'); ?> <strong style="color:red;"><?= format_currency($SMARTSTUDY->get_row(" SELECT SUM(`price`) FROM `payment_lempay` WHERE $where AND `status` = 1 ")['SUM(`price`)']); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                </tfoot>
