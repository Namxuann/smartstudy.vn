...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `payment_tripay` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `payment_tripay` WHERE $where ORDER BY id DESC ");
...
$total_yesterday = intval($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 AND  `created_at` LIKE '%" . $yesterday . "%' ")['SUM(price)']);
$total_today = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 AND `created_at` LIKE '%" . $currentDate . "%' ")['SUM(price)'];
$total_all_time = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 ")['SUM(price)'];
                            ...
                            <div class="row">
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control" name="tripay_status">
                                                    <option <?= $SMARTSTUDY->site('tripay_status') == 1 ? 'selected' : ''; ?> value="1">ON</option>
                                                    <option <?= $SMARTSTUDY->site('tripay_status') == 0 ? 'selected' : ''; ?> value="0">OFF</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control" name="tripay_sandbox">
                                                    <option <?= $SMARTSTUDY->site('tripay_sandbox') == 0 ? 'selected' : ''; ?> value="0">Production</option>
                                                    <option <?= $SMARTSTUDY->site('tripay_sandbox') == 1 ? 'selected' : ''; ?> value="1">Sandbox (Testing)</option>
                                                </select>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_name') ?: 'TriPay Indonesia'; ?>" name="tripay_name" placeholder="TriPay Indonesia">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center mb-2">
                                                    <?php if ($SMARTSTUDY->site('tripay_icon')): ?>
                                                        <img src="<?= base_url($SMARTSTUDY->site('tripay_icon')); ?>" width="40" height="40" class="me-2 rounded" style="object-fit: contain;">
                                                    <?php endif; ?>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_api_key'); ?>" name="tripay_api_key" placeholder="DEV-xxxxx">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_private_key'); ?>" name="tripay_private_key" placeholder="xxxxx-xxxxx-xxxxx">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label">Merchant Code</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_merchant_code'); ?>" name="tripay_merchant_code" placeholder="T12345">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_min'); ?>" name="tripay_min">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label">Max (IDR)</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_max'); ?>" name="tripay_max">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('tripay_rate'); ?>" name="tripay_rate">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="tripay_notice" name="tripay_notice"><?= $SMARTSTUDY->site('tripay_notice'); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']); ?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']); ?>
                                        </p>
                                ...
                                const data = {
                                    ...
                                    datasets: [{
                                        ...
                                        data: [
                                            ...
                                            for ($day = 1; $day <= $numOfDays; $day++) {
                                                $date = "$year-$month-$day";
                                                $row = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tripay WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="float-right">
                                                <?= __('Paid:'); ?> <strong style="color:red;"><?= format_currency($SMARTSTUDY->get_row(" SELECT SUM(`price`) FROM `payment_tripay` WHERE $where AND `status` = 1 ")['SUM(`price`)']); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                </tfoot>
