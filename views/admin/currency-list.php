...
if (isset($_POST['AddCurrency'])) {
    ...
    $isInsert = $SMARTSTUDY->insert("currencies", [
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable-basic" class="table text-nowrap table-striped table-hover table-bordered"
                            ...
                            <tbody>
                                <?php foreach ($SMARTSTUDY->get_list("SELECT * FROM `currencies` ORDER BY `id` DESC ") as $row) {?>
                                <tr>
                                    <td><?=$row['id'];?></td>
                                    <td><?=$row['name'];?></td>
                                    <td><?=$row['code'];?></td>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input name="rate" type="text" class="form-control" id="rate"
                                        placeholder="Bao nhiêu <?=$SMARTSTUDY->get_row(" SELECT `code` FROM `currencies` WHERE `display` = 1 AND `default_currency` = 1")['code'];?> cho 1 đơn vị tiền tệ này"
                                        value="" required>
