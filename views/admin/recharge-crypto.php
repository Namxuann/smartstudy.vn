...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `payment_crypto` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `payment_crypto` WHERE $where ORDER BY id DESC ");
...
$total_yesterday = intval($SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND `create_gettime` LIKE '%" . $yesterday . "%' ")['SUM(received)']);
$total_today = $SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND `create_gettime` LIKE '%" . $currentDate . "%' ")['SUM(received)'];
$total_all_time = $SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' ")['SUM(received)'];
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-6">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="crypto_status">
                                            <option <?= $SMARTSTUDY->site('crypto_status') == 1 ? 'selected' : ''; ?>
                                                value="1">ON
                                            </option>
                                            <option <?= $SMARTSTUDY->site('crypto_status') == 0 ? 'selected' : ''; ?>
                                                value="0">OFF
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="crypto_type_api" id="crypto_type_api"
                                            ...
                                            <!-- <option
                                                <?= $SMARTSTUDY->site('crypto_type_api') == 'fpayment.co' ? 'selected' : ''; ?>
                                                value="fpayment.co">FPAYMENT.CO | TRC20
                                            </option> -->
                                            <option
                                                <?= $SMARTSTUDY->site('crypto_type_api') == 'fpayment.net' ? 'selected' : ''; ?>
                                ...
                                <div id="fpaymentCoFields" class="crypto-fields">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?= $SMARTSTUDY->site('crypto_address'); ?>" name="crypto_address"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?= $SMARTSTUDY->site('crypto_token'); ?>" name="crypto_token"
                                ...
                                <div id="fpaymentNetFields" class="crypto-fields" style="display: none;">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?= $SMARTSTUDY->site('crypto_merchant_id'); ?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"
                                                value="<?= $SMARTSTUDY->site('crypto_api_key'); ?>" name="crypto_api_key">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 col-xl-6">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('crypto_min'); ?>"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?= $SMARTSTUDY->site('crypto_max'); ?>"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                value="<?= $SMARTSTUDY->site('crypto_rate'); ?>" name="crypto_rate"
...
" name="crypto_promotions"><?= $SMARTSTUDY->site('crypto_promotions'); ?></textarea>
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <p style="display:none;" id="hdsd_fpayment_co">Hướng dẫn sử dụng: <a target="_blank" class="text-primary"
                                        href="https://smartstudy.vn">https://smartstudy.vn</a>
                                </p>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea id="crypto_note"
                                            name="crypto_note"><?= $SMARTSTUDY->site('crypto_note'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-fill">
                                    <p class="mb-1 fs-5 fw-semibold text-default">
                                        <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND MONTH(create_gettime) = '$currentMonth' AND YEAR(create_gettime) = '$currentYear' ")['SUM(received)']); ?>
                                    </p>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-fill">
                                    <p class="mb-1 fs-5 fw-semibold text-default">
                                        <?= format_currency($SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND YEAR(create_gettime) = $currentYear AND WEEK(create_gettime, 1) = $currentWeek ")['SUM(received)']); ?>
                                    </p>
                            ...
                            const data = {
                                ...
                                datasets: [{
                                    ...
                                    data: [
                                        ...
                                        for ($day = 1; $day <= $numOfDays; $day++) {
                                            $date = "$year-$month-$day";
                                            $row = $SMARTSTUDY->get_row("SELECT SUM(received) FROM payment_crypto WHERE DATE(create_gettime) = '$date' AND  `status` = 'completed' ");
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="float-right">
                                            <?= __('Paid:'); ?>
                                            <strong
                                                style="color:red;"><?= format_currency($SMARTSTUDY->get_row(" SELECT SUM(`received`) FROM `payment_crypto` WHERE $where AND `status` = 'completed' ")['SUM(`received`)']); ?></strong>
                                            | <?= __('Unpaid:'); ?>
                                            <strong
                                                style="color:blue;"><?= format_currency($SMARTSTUDY->get_row(" SELECT SUM(`received`) FROM `payment_crypto` WHERE $where AND `status` = 'waiting' ")['SUM(`received`)']); ?></strong>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
