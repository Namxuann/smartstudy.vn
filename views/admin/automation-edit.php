...
if (isset($_GET['id'])) {
    ...
    $row = $SMARTSTUDY->get_row("SELECT * FROM `automations` WHERE `id` = '$id' ");
    if (!$row) {
...
if (isset($_POST['SaveTask'])) {
    ...
    $isUpdate = $SMARTSTUDY->update("automations", [
...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        $taskLogs = $SMARTSTUDY->get_list_safe("SELECT * FROM `logs` WHERE `device` = ? ORDER BY `id` DESC LIMIT 50", [$deviceKey]);
        ?>
        <div class="row mt-4">
            <div class="col-xl-12">
                <div class="card custom-card">
