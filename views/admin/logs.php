...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `logs` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `logs` WHERE $where ORDER BY id DESC ");
