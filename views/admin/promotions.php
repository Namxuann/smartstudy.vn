...
if (isset($_POST['AddPromotion'])) {
    ...
    $isInsert = $SMARTSTUDY->insert("promotions", [
        'discount'          => $discount,
...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `promotions` WHERE $where ORDER BY `min` ASC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `promotions` WHERE $where ORDER BY `min` ASC ");
