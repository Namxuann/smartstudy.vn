...
$body = [
    'title' => __('Products') . ' | ' . $SMARTSTUDY->site('title'),
                                        ...
                                        <?php foreach ($listDatatable as $product): ?>
                                            ...
                                            <div class="js-gallery img-fluid-100">
                                                ...
                                                <td>
                                                    ...
                                                    <b><?= format_cash($SMARTSTUDY->get_row(" SELECT COUNT(id) FROM product_die WHERE `product_code` = '" . $product['code'] . "' ")['COUNT(id)']); ?></b><br>
