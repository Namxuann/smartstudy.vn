...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `payment_tmweasyapi` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `payment_tmweasyapi` WHERE $where ORDER BY id DESC ");
...
$total_yesterday = intval($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 AND  `created_at` LIKE '%".$yesterday."%' ")['SUM(price)']);
$total_today = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 AND `created_at` LIKE '%".$currentDate."%' ")['SUM(price)'];
$total_all_time = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 ")['SUM(price)'];
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control" name="tmweasyapi_status">
                                                <option <?=$SMARTSTUDY->site('tmweasyapi_status') == 1 ? 'selected' : '';?>
                                                    value="1">ON
                                                </option>
                                                <option <?=$SMARTSTUDY->site('tmweasyapi_status') == 0 ? 'selected' : '';?>
                                                    value="0">
                                                    OFF
                                                </option>
                                            </select>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="tmweasyapi_username"
                                                value="<?=$SMARTSTUDY->site('tmweasyapi_username');?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="tmweasyapi_password"
                                                value="<?=$SMARTSTUDY->site('tmweasyapi_password');?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="tmweasyapi_con_id"
                                                value="<?=$SMARTSTUDY->site('tmweasyapi_con_id');?>"
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$SMARTSTUDY->site('tmweasyapi_rate');?>" name="tmweasyapi_rate"
                                                    placeholder="">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$SMARTSTUDY->site('tmweasyapi_min');?>" name="tmweasyapi_min">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                value="<?=$SMARTSTUDY->site('tmweasyapi_max');?>" name="tmweasyapi_max">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea id="tmweasyapi_notice"
                                                name="tmweasyapi_notice"><?=$SMARTSTUDY->site('tmweasyapi_notice');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- Watermark settings -->
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tmweasyapi_watermark_text"
                                                        value="<?=$SMARTSTUDY->site('tmweasyapi_watermark_text');?>"
                                                        name="tmweasyapi_watermark_text" placeholder="<?=$SMARTSTUDY->site('title');?>">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tmweasyapi_watermark_color"
                                                        value="<?=$SMARTSTUDY->site('tmweasyapi_watermark_color');?>"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="number" step="0.01" min="0" max="1" class="form-control" id="tmweasyapi_watermark_opacity"
                                                        value="<?=$SMARTSTUDY->site('tmweasyapi_watermark_opacity');?>"
                                            ...
                                            <div class="row mb-0">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="number" step="0.01" min="0.01" max="0.5" class="form-control" id="tmweasyapi_watermark_font_size"
                                                        value="<?=$SMARTSTUDY->site('tmweasyapi_watermark_font_size');?>"
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']);?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?=format_currency($SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']);?>
                                        </p>
      ...
      echo '<span class="fs-12 text-danger ms-2"><i class="ti ti-trending-down me-1 d-inline-block"></i>' . round(abs($revenueGrowth), 2) . '% </span>';
            ...
            <div class="col-xl-7">
              ...
              ?>
                  ...
                  for ($day = 1; $day <= $numOfDays; $day++) {
                      $date = "$year-$month-$day";
                      $row = $SMARTSTUDY->get_row("SELECT SUM(price) FROM payment_tmweasyapi WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="float-right">
                                                <?=__('Paid:');?>
                                                <strong
                                                    style="color:red;"><?=format_currency($SMARTSTUDY->get_row(" SELECT SUM(`price`) FROM `payment_tmweasyapi` WHERE $where AND `status` = 1 ")['SUM(`price`)']);?></strong>
