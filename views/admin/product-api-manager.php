...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `products` WHERE $where $orderBy LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `products` WHERE $where ");
    ...
    <div class="container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane show text-muted" id="tab1" role="tabpanel">
                <?php
                $doanh_thu = $SMARTSTUDY->get_row(" SELECT SUM(pay) FROM product_order WHERE `refund` = 0 AND supplier_id = '$id' ")['SUM(pay)'];
                $tien_von = $SMARTSTUDY->get_row(" SELECT SUM(cost) FROM product_order WHERE `refund` = 0 AND supplier_id = '$id' ")['SUM(cost)'];
                                    ...
                                    <div class="flex-fill">
                                        <div class="d-flex mb-1 align-items-top justify-content-between">
                                            <h5 class="fw-semibold mb-0 lh-1">
                                                <?= format_cash($SMARTSTUDY->get_row(" SELECT COUNT(id) FROM product_order WHERE refund = 0 AND supplier_id = '$id' ")['COUNT(id)']); ?>
                                            </h5>
                                        </div>
