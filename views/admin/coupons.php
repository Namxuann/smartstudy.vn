...
if (isset($_POST['AddCoupon'])) {
    ...
    if($SMARTSTUDY->get_row("SELECT * FROM `coupons` WHERE `code` = '$code' ")){
    ...
    $isInsert = $SMARTSTUDY->insert("coupons", [
        'code'          => $code,
...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `coupons` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `coupons` WHERE $where ORDER BY id DESC ");
                            ...
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><span style="font-size: 15px;"
                                                class="badge bg-danger"><?=format_cash($SMARTSTUDY->num_rows(" SELECT * FROM coupon_used WHERE `coupon_id` = '".$row['id']."' "));?></span>
                                        </td>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="product_id[]" id="listProduct" multiple>
                                ...
                                <optgroup label="__<?=$category['name'];?>__">
                                    <?php foreach($SMARTSTUDY->get_list(" SELECT * FROM `products` WHERE `category_id` = '".$category['id']."' ") as $product):?>
