...
if (isset($_POST['AddPage'])) {
    ...
    $isInsert = $SMARTSTUDY->insert("payment_manual", [
        'icon'              => $url_icon,
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="datatable-basic" class="table text-nowrap table-striped table-hover table-bordered"
                            ...
                            <tbody>
                                <?php $i = 0; foreach ($SMARTSTUDY->get_list("SELECT * FROM `payment_manual`  ") as $payment_manual) {?>
                                <tr>
                                    <td><?=$i++;?></td>
                        ...
                        <p>Hướng dẫn sử dụng chức năng này tại: <a class="text-primary"
                                ...
                                target="_blank">https://smartstudy.vn</a>
                        </p>
                    </div>
                </div>
            </div>
