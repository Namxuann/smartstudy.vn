...
$body = [
    'title' => __('Danh sách bài viết').' | '.$SMARTSTUDY->site('title'),
...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `posts` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `posts` WHERE $where ORDER BY id DESC ");
                            ...
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <div class="col-md-3 col-6">
                                    <select class="form-control form-control-sm mb-1" name="category">
                                        ...
                                        <?php foreach($SMARTSTUDY->get_list(" SELECT * FROM `post_category` ") as $listcategory):?>
