...
if (isset($_POST['SaveSettings'])) {
    ...
    $allowedKeys = ['ctv_status','ctv_min_withdraw','ctv_fee_withdraw','ctv_prefix_withdraw','ctv_banks_withdraw','ctv_notice_withdraw','ctv_notice'];
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="ctv_status">
                                    <option <?=$SMARTSTUDY->site('ctv_status') == 1 ? 'selected' : '';?> value="1">
                                        <i class="fas fa-check-circle text-success"></i> ON - Kích hoạt
                                    </option>
                                    <option <?=$SMARTSTUDY->site('ctv_status') == 0 ? 'selected' : '';?> value="0">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" step="1000" class="form-control" name="ctv_min_withdraw"
                                    value="<?=$SMARTSTUDY->site('ctv_min_withdraw');?>" placeholder="Nhập số tiền tối thiểu">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" max="100" step="0.1" class="form-control" name="ctv_fee_withdraw"
                                    value="<?=$SMARTSTUDY->site('ctv_fee_withdraw');?>" placeholder="Nhập phần trăm phí rút tiền">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="ctv_prefix_withdraw"
                                    value="<?=$SMARTSTUDY->site('ctv_prefix_withdraw');?>" placeholder="Ví dụ: CTV">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="ctv_banks_withdraw" rows="8"
                                    placeholder="Mỗi dòng 1 ngân hàng, có thể nhập tên viết tắt ngân hàng hoặc USDT."><?=$SMARTSTUDY->site('ctv_banks_withdraw');?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="ctv_notice" rows="6"
                                    placeholder="Nội dung HTML được hỗ trợ."><?=$SMARTSTUDY->site('ctv_notice');?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="ctv_notice_withdraw" rows="6"
                                    placeholder="Nội dung HTML được hỗ trợ."><?=$SMARTSTUDY->site('ctv_notice_withdraw');?></textarea>
