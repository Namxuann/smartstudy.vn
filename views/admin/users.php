...
<?php
    ...
    if ($SMARTSTUDY->num_rows("SELECT * FROM `users` WHERE `username` = '$username' ") > 0) {
    ...
    if ($SMARTSTUDY->num_rows("SELECT * FROM `users` WHERE `email` = '$email' ") > 0) {
    ...
    $isInsert = $SMARTSTUDY->insert('users', [
        'username'  => check_string($_POST['username']),
...
$users = $SMARTSTUDY->get_list("SELECT * FROM `users` ORDER BY id DESC  ");
...
$listDatatable = $SMARTSTUDY->get_list("SELECT * FROM `users` WHERE $where $order_by LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `users` WHERE $where ORDER BY id DESC ");
                            ...
                            <div class="flex-fill">
                                <div class="d-flex mb-1 align-items-top justify-content-between">
                                    <h5 class="fw-semibold mb-0 lh-1">
                                        <?=format_cash($SMARTSTUDY->get_row(" SELECT COUNT(id) FROM users ")['COUNT(id)']);?>
                                    </h5>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                <div class="d-flex mb-1 align-items-top justify-content-between">
                                    <h5 class="fw-semibold mb-0 lh-1">
                                        <?=format_currency($SMARTSTUDY->get_row(" SELECT SUM(money) FROM users ")['SUM(money)']);?>
                                    </h5>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                <div class="d-flex mb-1 align-items-top justify-content-between">
                                    <h5 class="fw-semibold mb-0 lh-1">
                                        <?=format_cash($SMARTSTUDY->get_row(" SELECT COUNT(id) FROM users WHERE `admin` != 0 ")['COUNT(id)']);?>
                                    </h5>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                <div class="d-flex mb-1 align-items-top justify-content-between">
                                    <h5 class="fw-semibold mb-0 lh-1">
                                        <?=format_cash($SMARTSTUDY->get_row(" SELECT COUNT(id) FROM users WHERE `banned` != 0 ")['COUNT(id)']);?>
                                    </h5>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-wrapper mb-3">
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tfoot>
                                    <td colspan="<?=$SMARTSTUDY->site('ctv_status') == 1 ? '12' : '11';?>">
                                        <div class="btn-list">
