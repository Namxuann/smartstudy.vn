                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <select class="form-control mb-1"
                                                                        ...
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_zalo1_status') == 1 ? 'selected' : ''; ?>
                                                                            value="1">ON
                                                                        </option>
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_zalo1_status') == 0 ? 'selected' : ''; ?>
                                                                            value="0">
                                                                            OFF
                                                                        </option>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $SMARTSTUDY->site('widget_zalo1_sdt'); ?>"
                                                    ...
                                                    <table class="mb-3 table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <select class="form-control mb-1"
                                                                        ...
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_fbzalo2_status') == 1 ? 'selected' : ''; ?>
                                                                            value="1">ON
                                                                        </option>
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_fbzalo2_status') == 0 ? 'selected' : ''; ?>
                                                                            value="0">
                                                                            OFF
                                                                        </option>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $SMARTSTUDY->site('widget_fbzalo2_zalo'); ?>"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $SMARTSTUDY->site('widget_fbzalo2_fb'); ?>"
                                                    ...
                                                    <table class="mb-3 table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <select class="form-control mb-1"
                                                                        ...
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_phone1_status') == 1 ? 'selected' : ''; ?>
                                                                            value="1">ON
                                                                        </option>
                                                                        <option
                                                                            <?= $SMARTSTUDY->site('widget_phone1_status') == 0 ? 'selected' : ''; ?>
                                                                            value="0">
                                                                            OFF
                                                                        </option>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $SMARTSTUDY->site('widget_phone1_sdt'); ?>"
