...
if (isset($_GET['id'])) {
    ...
    if (!$row = $SMARTSTUDY->get_row("SELECT * FROM `post_category` WHERE `id` = '$id' ")) {
...
if (isset($_POST['SaveCategory'])) {
    ...
    if ($SMARTSTUDY->get_row("SELECT * FROM `post_category` WHERE `name` = '".check_string($_POST['name'])."' AND `id` != ".$row['id']." ")) {
    ...
    if (check_img('icon') == true) {
        ...
        if ($addlogo) {
            $SMARTSTUDY->update("post_category", [
                'icon' => $uploads_dir
            ], " `id` = '".$row['id']."' ");
        }
    }
    $isInsert = $SMARTSTUDY->update("post_category", [
