...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `aff_log` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `aff_log` WHERE $where ORDER BY id DESC ");
