...
if (isset($_POST['SaveSettings'])) {
    ...
    if (check_img('logo_light') == true) {
        unlink($SMARTSTUDY->site('logo_light'));
    ...
    if (check_img('logo_dark') == true) {
        unlink($SMARTSTUDY->site('logo_dark'));
        $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
    ...
    if (check_img('favicon') == true) {
        unlink($SMARTSTUDY->site('favicon'));
        $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
    ...
    if (check_img('default_product_image') == true) {
        unlink($SMARTSTUDY->site('default_product_image'));
        $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
    ...
    if (check_img('banner_singer') == true) {
        unlink($SMARTSTUDY->site('banner_singer'));
        $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="bg-light rounded p-3" src="<?=BASE_URL($SMARTSTUDY->site('logo_light'));?>" alt="Logo Light">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="bg-light rounded p-3" src="<?=BASE_URL($SMARTSTUDY->site('logo_dark'));?>" alt="Logo Dark">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="50px" class="rounded-circle" src="<?=BASE_URL($SMARTSTUDY->site('favicon'));?>" alt="Favicon">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="rounded" src="<?=BASE_URL($SMARTSTUDY->site('image'));?>" alt="Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="rounded" src="<?=BASE_URL($SMARTSTUDY->site('default_product_image'));?>" alt="Default Product Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="rounded" src="<?=BASE_URL($SMARTSTUDY->site('banner_singer'));?>" alt="Banner Singer">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-2">
                                        <img width="250px" class="rounded-circle" src="<?=BASE_URL($SMARTSTUDY->site('avatar'));?>" alt="Avatar">
                                    </div>
                                </div>
                            </div>
