...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `dongtien` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `dongtien` WHERE $where ORDER BY id DESC ");
