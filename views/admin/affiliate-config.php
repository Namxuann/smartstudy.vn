...
$body = [
    'title' => __('Cấu hình Tiếp Thị Liên Kết').' | '.$SMARTSTUDY->site('title'),
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control" name="affiliate_status" required>
                                                <option <?=$SMARTSTUDY->site('affiliate_status') == 1 ? 'selected' : '';?>
                                                    value="1">
                                                    <?=__('ON');?></option>
                                                <option <?=$SMARTSTUDY->site('affiliate_status') == 0 ? 'selected' : '';?>
                                                    value="0">
                                                    <?=__('OFF');?></option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$SMARTSTUDY->site('affiliate_ck');?>" name="affiliate_ck"
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$SMARTSTUDY->site('affiliate_min');?>" name="affiliate_min"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <textarea class="form-control" rows="4"
                                                    ...
                                                    name="affiliate_banks"><?=$SMARTSTUDY->site('affiliate_banks');?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    value="<?=$SMARTSTUDY->site('affiliate_chat_id_telegram');?>"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea id="affiliate_note"
                                                name="affiliate_note"><?=$SMARTSTUDY->site('affiliate_note');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
