...
$body = [
    'title' => __('Sản phẩm chờ duyệt CTV').' | '.$SMARTSTUDY->site('title'),
...
$listDatatable = $SMARTSTUDY->get_list(" SELECT * FROM `products` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $SMARTSTUDY->num_rows(" SELECT * FROM `products` WHERE $where ORDER BY id DESC ");
                            ...
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-md-3 col-6">
                                    <select class="form-control js-example-basic-single" name="ctv_id">
                                        ...
                                        <?php foreach($SMARTSTUDY->get_list("SELECT * FROM `users` WHERE `ctv` = 1 ORDER BY `id` DESC") as $ctv):?>
                                ...
                                <div class="col-md-3 col-6">
                                    <select class="form-control js-example-basic-single" name="category_id">
                                        ...
                                        <?php foreach($SMARTSTUDY->get_list("SELECT * FROM `categories` ORDER BY `id` DESC") as $category):?>
                        ...
                        <div class="table-responsive table-wrapper mb-3">
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        $ctv = $SMARTSTUDY->get_row("SELECT * FROM `users` WHERE `id` = '".$product['user_id']."'");
                                        $category = $SMARTSTUDY->get_row("SELECT * FROM `categories` WHERE `id` = '".$product['category_id']."'");
