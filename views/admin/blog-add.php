...
if (isset($_POST['submit'])) {
    ...
    if ($SMARTSTUDY->get_row("SELECT * FROM `posts` WHERE `title` = '".check_string($_POST['title'])."' ")) {
    ...
    $isInsert = $SMARTSTUDY->insert("posts", [
        'user_id'       => $getUser['id'],
        'image'          => $url_icon,
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-select" name="category_id" required>
                                            ...
                                            <?php foreach($SMARTSTUDY->get_list(" SELECT * FROM `post_category` ") as $category):?>
