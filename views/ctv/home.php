...
$body = [
    'title' => 'CTV Dashboard | '.$SMARTSTUDY->site('title'),
                        ...
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                ...
                                <h5 class="fw-semibold mb-2" id="orders_today">
                                    <?php
                                    $orders_today = $SMARTSTUDY->get_row_safe("SELECT COUNT(*) as total FROM `product_order` WHERE DATE(`create_gettime`) = CURDATE() AND `seller` = ?", [$getUser['id']]);
                        ...
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                ...
                                <h5 class="fw-semibold mb-2" id="revenue_today">
                                    <?php
                                    $revenue_today = $SMARTSTUDY->get_row_safe("SELECT SUM(`pay`) as total FROM `product_order` WHERE DATE(`create_gettime`) = CURDATE() AND `seller` = ?", [$getUser['id']]);
                        ...
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                ...
                                <h5 class="fw-semibold mb-2">
                                    <?php
                                    $total_orders = $SMARTSTUDY->get_row_safe("SELECT COUNT(*) as total FROM `product_order` WHERE `seller` = ?", [$getUser['id']]);
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                ...
                                <h5 class="fw-semibold mb-2">
                                    <?php
                                    $total_revenue = $SMARTSTUDY->get_row_safe("SELECT SUM(`pay`) as total FROM `product_order` WHERE `seller` = ?", [$getUser['id']]);
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-top">
                            ...
                            <div class="flex-fill">
                                ...
                                <h5 class="fw-semibold mb-2">
                                    <?php
                                    $total_customers = $SMARTSTUDY->get_row_safe("SELECT COUNT(DISTINCT `buyer`) as total FROM `product_order` WHERE `seller` = ?", [$getUser['id']]);
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $recent_orders = $SMARTSTUDY->get_list_safe("SELECT po.*, p.name as product_name, u.username 
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <?php
                            $stats_7days = $SMARTSTUDY->get_row_safe("SELECT 
                                                            COUNT(*) as orders,
                                                            SUM(pay) as revenue,
                        ...
                        <div class="mb-4">
                            ...
                            <?php
                            $stats_month = $SMARTSTUDY->get_row_safe("SELECT 
                                                           COUNT(*) as orders,
                                                           SUM(pay) as revenue,
                                                           SUM(commission_fee) as commission
                                                           FROM `product_order` 
                        ...
                        <div>
                            ...
                            <?php
                            $top_products = $SMARTSTUDY->get_list_safe("SELECT p.name, COUNT(po.id) as sold, SUM(po.pay) as revenue
                                                             FROM `product_order` po 
                                                             LEFT JOIN `products` p ON po.product_id = p.id 
                                                             WHERE po.seller = ?
