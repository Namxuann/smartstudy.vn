                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="<?= base_url_ctv(); ?>" class="header-logo">
                                <img src="<?= base_url($SMARTSTUDY->site('logo_light')); ?>" alt="logo" class="desktop-logo">
                                <img src="<?= base_url($SMARTSTUDY->site('favicon')); ?>" alt="logo" class="toggle-logo">
                                <img src="<?= base_url($SMARTSTUDY->site('logo_dark')); ?>" alt="logo" class="desktop-dark">
                                <img src="<?= base_url($SMARTSTUDY->site('favicon')); ?>" alt="logo" class="toggle-dark">
                                <img src="<?= base_url($SMARTSTUDY->site('logo_light')); ?>" alt="logo" class="desktop-white">
                                <img src="<?= base_url($SMARTSTUDY->site('favicon')); ?>" alt="logo" class="toggle-white">
                            </a>
                        </div>
                    </div>
                    <!-- End::header-element -->
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide">
                            <a href="<?= base_url_ctv('settings'); ?>"
                                class="side-menu__item <?= active_sidebar(['settings']); ?>">
                                <i class="bx bx-cog side-menu__icon"></i>
                                <span class="side-menu__label">Cấu hình</span>
                            </a>
                        </li>
